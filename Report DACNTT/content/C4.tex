...
Thực nghiệm của dự án tập trung vào nhóm người dùng và sản phẩm đã có đủ lịch sử tương tác sau khi lọc $k$-core (mục~\ref{subsec:interaction_matrix}). Bài toán khởi đầu lạnh (Cold-start) cho người dùng/sản phẩm hoàn toàn mới, chưa có bất kỳ tương tác nào, không được thực nghiệm và đánh giá định lượng trong phạm vi dự án này; đây được ghi nhận là một hạn chế và hướng phát triển trong tương lai (mục~\ref{sec:hanche}, Chương~\ref{chap:ketluan}). Ngoài ra, kết quả trên H\&M (Bảng~\ref{tab:results_hm}) được đo trên lát cắt 100.000 dòng giao dịch đầu, không phải toàn bộ 31,8 triệu dòng của bộ dữ liệu gốc (lý do kỹ thuật và số liệu định lượng cụ thể tại mục~\ref{subsec:hm_apply}); các kết luận rút ra từ H\&M trong chương này cần được xác nhận lại ở quy mô đầy đủ trước khi tổng quát hoá.
